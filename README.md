...
## Free Generation and Adjunctions
...
2. **Yoneda Embedding**
   ...
   - Objects as determined by the ways other objects map to them (or from them)

3. **Yoneda Lemma**
   - General mapping principle
   - The unit of the Yoneda embedding
   - Forms by layer: how Yoneda looks at different levels (elements, functors, natural transformations, universality)
